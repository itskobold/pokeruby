...
static const u16 sBattleTowerHeldItems[] =
{
    ...
    ITEM_BLACK_GLASSES,
    ITEM_BLACK_BELT,
    ITEM_POTION, //ITEM_SOUL_DEW
    ITEM_CHOICE_BAND,
    ITEM_MAGNET,
    ITEM_SILK_RIBBON,
    ITEM_POTION, //ITEM_WHITE_HERB
    ITEM_DEEP_SEA_SCALE,
    ITEM_DEEP_SEA_TOOTH,
    ITEM_MYSTIC_WATER,
    ITEM_SHARP_BEAK,
    ...
    ITEM_DRAGON_FANG,
    ITEM_WIKI_BERRY,
    ITEM_POTION, //orignally sea incense
    ITEM_SHELL_BELL,
    ITEM_SALAC_BERRY,
    ITEM_APICOT_BERRY,
    ITEM_STARF_BERRY,
    ITEM_LIECHI_BERRY,
    ITEM_POTION, //ITEM_STICK
    ITEM_POTION, //ITEM_LAX_INCENSE
    ITEM_AGUAV_BERRY,
    ITEM_FIGY_BERRY,
    ITEM_POTION, //ITEM_THICK_CLUB
    ITEM_POTION, //ITEM_METAL_POWDER
    ITEM_PETAYA_BERRY,
    ITEM_POTION, //ITEM_LUCKY_PUNCH
    ITEM_GANLON_BERRY,
};
