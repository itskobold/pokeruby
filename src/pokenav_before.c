...
static void sub_80F468C(s16 arg0, u8 arg1)
{
    ...
    if (gUnknown_083DFEC4->unk893c[arg0].unk4)
    {
		...
		//changed MON_DATA_CUTE etc to MON_DATA_IS_EGG just so it'll compile. this will all be removed eventually
        gUnknown_083DFEC4->unk8ff0[arg1][0] = sub_80F44B0(box, monIndex, MON_DATA_IS_EGG, NULL);
        gUnknown_083DFEC4->unk8ff0[arg1][1] = sub_80F44B0(box, monIndex, MON_DATA_IS_EGG, NULL);
        gUnknown_083DFEC4->unk8ff0[arg1][2] = sub_80F44B0(box, monIndex, MON_DATA_IS_EGG, NULL);
        gUnknown_083DFEC4->unk8ff0[arg1][3] = sub_80F44B0(box, monIndex, MON_DATA_IS_EGG, NULL);
        gUnknown_083DFEC4->unk8ff0[arg1][4] = sub_80F44B0(box, monIndex, MON_DATA_IS_EGG, NULL);

        gUnknown_083DFEC4->unk8931[arg1] = sub_80F44B0(box, monIndex, MON_DATA_IS_EGG, NULL) != 255
            ? sub_80F44B0(box, monIndex, MON_DATA_IS_EGG, NULL) / 29
            : 9;
