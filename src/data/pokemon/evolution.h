...
struct Evolution gEvolutionTable[NUM_SPECIES][NUM_MAX_POSSIBLE_EVOLUTIONS] =
{
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_POLITOED}}, 		//CHANGED
    [SPECIES_ABRA]       = {{EVO_LEVEL, 16, SPECIES_KADABRA}},
    [SPECIES_KADABRA]    = {{EVO_LEVEL, 30, SPECIES_ALAKAZAM}}, 					//CHANGED
    [SPECIES_MACHOP]     = {{EVO_LEVEL, 28, SPECIES_MACHOKE}},
    [SPECIES_MACHOKE]    = {{EVO_LEVEL, 40, SPECIES_MACHAMP}}, 						//CHANGED
    ...
    [SPECIES_GRAVELER]   = {{EVO_LEVEL, 40, SPECIES_GOLEM}}, 						//CHANGED
    [SPECIES_PONYTA]     = {{EVO_LEVEL, 40, SPECIES_RAPIDASH}},
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_SLOWKING}}, 			//CHANGED
    ...
    [SPECIES_HAUNTER]    = {{EVO_LEVEL, 40, SPECIES_GENGAR}}, 						//CHANGED
    [SPECIES_ONIX]       = {{EVO_LEVEL, 50, SPECIES_STEELIX}}, 						//CHANGED
    ...
    [SPECIES_SCYTHER]    = {{EVO_LEVEL, 40, SPECIES_SCIZOR}}, 						//CHANGED
    [SPECIES_MAGIKARP]   = {{EVO_LEVEL, 20, SPECIES_GYARADOS}},
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ESPEON}, 					//CHANGED
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_UMBREON}}, 				//CHANGED
    [SPECIES_PORYGON]    = {{EVO_LEVEL, ITEM_UP_GRADE, SPECIES_PORYGON2}},
    ...
    [SPECIES_FEEBAS]     = {{EVO_LEVEL, 40, SPECIES_MILOTIC}}, 						//CHANGED
    ...
    [SPECIES_CLAMPERL]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_HUNTAIL},			//CHANGED
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_GOREBYSS}},			//CHANGED
...
/*struct Evolution gEvolutionTable[NUM_SPECIES][5] = VANILLA
{
    [SPECIES_BULBASAUR]  = {{EVO_LEVEL, 16, SPECIES_IVYSAUR}},
    [SPECIES_IVYSAUR]    = {{EVO_LEVEL, 32, SPECIES_VENUSAUR}},
    [SPECIES_CHARMANDER] = {{EVO_LEVEL, 16, SPECIES_CHARMELEON}},
