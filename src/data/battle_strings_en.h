...
const u8 BattleText_HustleUse[] = _("{STRING 16}’s {STRING 19} increased\nits chance to get a critical-hit!");
...
//const u8 BattleText_Nightmare[] = _("nightmare");
//const u8 BattleText_Cursed[] = _("curse");
//const u8 BattleText_Torment[] = _("torment");
//const u8 BattleText_Yawn[] = _("drowziness");
