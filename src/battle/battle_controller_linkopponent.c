...
u32 dp01_getattr_by_ch1_for_player_pokemon__(u8 a, u8 *buffer)
{
    ...
    case 48:
        ...
        break;
    case 49:
        buffer[0] = GetMonData(&gEnemyParty[a], MON_DATA_TYPE_1);
        size = 1;
        break;
    case 50:
        buffer[0] = GetMonData(&gEnemyParty[a], MON_DATA_TYPE_2);
        size = 1;
        break;
    case 51:
        buffer[0] = GetMonData(&gEnemyParty[a], MON_DATA_HIDDEN_TYPE);
        size = 1;
        break;
    case 52:
        data16 = GetMonData(&gEnemyParty[a], MON_DATA_ABILITY);
        buffer[0] = data16;
        buffer[1] = data16 >> 8;
        size = 2;
        break;
...
void sub_8038900(u8 a)
{
    ...
    case 48:
        ...
        break;
    case 49:
        SetMonData(&gEnemyParty[a], MON_DATA_TYPE_1, &gBattleBufferA[gActiveBattler][3]);
        break;
    case 50:
        SetMonData(&gEnemyParty[a], MON_DATA_TYPE_2, &gBattleBufferA[gActiveBattler][3]);
        break;
    case 51:
        SetMonData(&gEnemyParty[a], MON_DATA_HIDDEN_TYPE, &gBattleBufferA[gActiveBattler][3]);
        break;
    case 52:
        SetMonData(&gEnemyParty[a], MON_DATA_ABILITY, &gBattleBufferA[gActiveBattler][3]);
        break;
    case 53:
        SetMonData(&gEnemyParty[a], MON_DATA_33, &gBattleBufferA[gActiveBattler][3]);
        break;
    case 54:
        SetMonData(&gEnemyParty[a], MON_DATA_33, &gBattleBufferA[gActiveBattler][3]);
        break;
