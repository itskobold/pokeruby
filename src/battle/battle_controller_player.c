...
u32 dp01_getattr_by_ch1_for_player_pokemon_(u8 a, u8 *buffer)
{
    ...
    case 0:
		...
		battlePokemon.type1 = GetMonData(&gPlayerParty[a], MON_DATA_TYPE_1);
		battlePokemon.type2 = GetMonData(&gPlayerParty[a], MON_DATA_TYPE_2);
		battlePokemon.ability = GetMonData(&gPlayerParty[a], MON_DATA_ABILITY);
...
void dp01_setattr_by_ch1_for_player_pokemon(u8 a)
{
    ...
    case 48:
        ...
        break;
    case 49:
        SetMonData(&gPlayerParty[a], MON_DATA_TYPE_1, &gBattleBufferA[gActiveBattler][3]);
        break;
    case 50:
        SetMonData(&gPlayerParty[a], MON_DATA_TYPE_2, &gBattleBufferA[gActiveBattler][3]);
        break;
    case 51:
        SetMonData(&gPlayerParty[a], MON_DATA_HIDDEN_TYPE, &gBattleBufferA[gActiveBattler][3]);
        break;
    case 52:
        SetMonData(&gPlayerParty[a], MON_DATA_ABILITY, &gBattleBufferA[gActiveBattler][3]);
        break;
    case 53:
        SetMonData(&gPlayerParty[a], MON_DATA_33, &gBattleBufferA[gActiveBattler][3]);
        break;
    case 54:
        SetMonData(&gPlayerParty[a], MON_DATA_33, &gBattleBufferA[gActiveBattler][3]);
        break;
