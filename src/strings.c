...
const u8 gOtherText_HPIVRaised[] = _("{STR_VAR_1}’s HP IV was raised.{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_AttackIVRaised[] = _("{STR_VAR_1}’s ATTACK IV\nwas raised.{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_DefenseIVRaised[] = _("{STR_VAR_1}’s DEFENSE IV\nwas raised.{PAUSE_UNTIL_PRESS}");
...
const u8 gOtherText_HiddenTypeChanged[] = _("{STR_VAR_1}’s hidden type\nwas changed.{PAUSE_UNTIL_PRESS}");
...
const u8 gOtherText_WasRaised[] = _("{STR_VAR_1}’s {STR_VAR_2} EV\nwas raised.{PAUSE_UNTIL_PRESS}");
