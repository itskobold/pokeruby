...
#define TIME_EARLY_SPRING		((TIME_DAY_MONDAY | TIME_DAY_TUESDAY | TIME_DAY_WEDNESDAY | TIME_DAY_THURSDAY & TIME_WEEK_0 & TIME_SEASON_SPRING))
//#define TIME_MID_SPRING
#define TIME_LATE_SPRING		((TIME_DAY_THURSDAY | TIME_DAY_FRIDAY | TIME_DAY_SATURDAY | TIME_DAY_SUNDAY & TIME_WEEK_1 & TIME_SEASON_SPRING))
#define TIME_EARLY_SUMMER		((TIME_DAY_MONDAY | TIME_DAY_TUESDAY | TIME_DAY_WEDNESDAY | TIME_DAY_THURSDAY & TIME_WEEK_0 & TIME_SEASON_SUMMER))
//#define TIME_MID_SUMMER
#define TIME_LATE_SUMMER		((TIME_DAY_THURSDAY | TIME_DAY_FRIDAY | TIME_DAY_SATURDAY | TIME_DAY_SUNDAY & TIME_WEEK_1 & TIME_SEASON_SUMMER))
#define TIME_EARLY_FALL			((TIME_DAY_MONDAY | TIME_DAY_TUESDAY | TIME_DAY_WEDNESDAY | TIME_DAY_THURSDAY & TIME_WEEK_0 & TIME_SEASON_FALL))
//#define TIME_MID_FALL
#define TIME_LATE_FALL			((TIME_DAY_THURSDAY | TIME_DAY_FRIDAY | TIME_DAY_SATURDAY | TIME_DAY_SUNDAY & TIME_WEEK_1 & TIME_SEASON_FALL))
#define TIME_EARLY_WINTER		((TIME_DAY_MONDAY | TIME_DAY_TUESDAY | TIME_DAY_WEDNESDAY | TIME_DAY_THURSDAY & TIME_WEEK_0 & TIME_SEASON_WINTER))
//#define TIME_MID_WINTER
#define TIME_LATE_WINTER		((TIME_DAY_THURSDAY | TIME_DAY_FRIDAY | TIME_DAY_SATURDAY | TIME_DAY_SUNDAY & TIME_WEEK_1 & TIME_SEASON_WINTER))
