...
extern const u8 gOtherText_HPIVRaised[];
extern const u8 gOtherText_AttackIVRaised[];
extern const u8 gOtherText_DefenseIVRaised[];
...
extern const u8 gOtherText_HiddenTypeChanged[];
