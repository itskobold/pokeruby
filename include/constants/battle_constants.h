...
//#define STATUS_SCORCH			0x100
//#define STATUS_BERZERK		0x200
#define STATUS_TOXIC_COUNTER    0xF00

#define STATUS_PSN_ANY          ((STATUS_POISON | STATUS_TOXIC_POISON))
//#define STATUS_BRN_ANY          ((STATUS_BURN | STATUS_SCORCH))
#define STATUS_ANY              ((STATUS_SLEEP | STATUS_POISON | STATUS_BURN | STATUS_FREEZE | STATUS_PARALYSIS | STATUS_TOXIC_POISON))//STATUS_SCORCH | STATUS_BERZERK))
