...
extern const u8 gSystemText_Keyboard[];
...
extern const u8 gSystemText_HoldB[];
extern const u8 gSystemText_Auto[];
extern const u8 gSystemText_Swap[];
extern const u8 gSystemText_SendToPC[];
extern const u8 gSystemText_QWERTY[];
extern const u8 gSystemText_QWERTYPlus[];
extern const u8 gSystemText_ABC[];
extern const u8 gSystemText_ABCPlus[];
extern const u8 gSystemText_AZERTY[];
extern const u8 gSystemText_AZERTYPlus[];
extern const u8 gSystemText_Dvorak[];
extern const u8 gSystemText_DvorakPlus[];
extern const u8 gSystemText_Colemak[];
extern const u8 gSystemText_ColemakPlus[];
extern const u8 gSystemText_Vanilla[];
extern const u8 gSystemText_Rocket[];
extern const u8 gSystemText_Magma[];
extern const u8 gSystemText_Aqua[];
...
extern const u8 gSystemText_FullPartyDeadlockeDescription[];
...
extern const u8 SystemText_Trade[];
extern const u8 SystemText_Battle[];
